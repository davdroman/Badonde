...
final class PullRequestURLFactoryTests: XCTestCase {
	...
	func testFactory_urlIsValid_withBranches_withTitle() {
		...
		XCTAssertEqual(try factory.url().absoluteString, "https://github.com/user/repo/compare/base...target?title=Title%20of%20the%20PR%20100%25%20correctly%20encoded%20with%20extra%20emoji%20sauce!%20%F0%9F%8D%97%F0%9F%A5%97%F0%9F%92%AA%F0%9F%8F%83%E2%80%8D%E2%99%82%EF%B8%8F")
	}
	...
	func testFactory_urlIsValid_withBranches_withZeroLabels() {
		...
		factory.targetBranch = "target"
		factory.labels = []
		XCTAssertEqual(try factory.url().absoluteString, "https://github.com/user/repo/compare/base...target?labels=")
	}
	...
	func testFactory_urlIsValid_withBranches_withOneLabel() {
		...
		XCTAssertEqual(try factory.url().absoluteString, "https://github.com/user/repo/compare/base...target?labels=Label%201")
	}
	...
	func testFactory_urlIsValid_withBranches_withMultipleLabels() {
		...
		XCTAssertEqual(try factory.url().absoluteString, "https://github.com/user/repo/compare/base...target?labels=Label%201,Label%202,Label%203")
	}
	...
	func testFactory_urlIsValid_withBranches_withMilestone() {
		...
		XCTAssertEqual(try factory.url().absoluteString, "https://github.com/user/repo/compare/base...target?milestone=RT%20%E2%88%9E")
	}
}
